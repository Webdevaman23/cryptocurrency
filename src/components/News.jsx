...
const { data : cryptoNews , isError} = useGetCryptoNewsQuery({count : simplified ? 6 : 12})  
            ...
            <Card hoverable className='news-card'>
              <a href={news.url} target='_blank' rel="noreferrer">
                <div className='news-image-container'>
                  ...
                  <img style={{maxHeight: '150px' , maxWidth: '200px'}} src={news?.thumbnail || demoImage} alt='news' />
                </div>
                <p>
                ...
                <div className='provider-container'>
                  <div>
                    <Avatar src={news.thumbnail?.url || demoImage} alt='news'  />
